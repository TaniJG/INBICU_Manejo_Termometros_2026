...
void setup()
{
  ...
  WiFi.disconnect(true); // Desconecta y borra configuraciones previas de la memoria
  delay(1000);
  WiFi.mode(WIFI_STA);
  ...
  config.fb_count = 2;
  config.grab_mode = CAMERA_GRAB_LATEST; // ¡Crucial para traer la foto actual!
...
String sendPhoto()
{
  ...
  if (client.connect(serverName.c_str(), serverPort))
  {
    ...
    String head_photo = "--DjangoBoundary\r\nContent-Disposition: form-data; name=\"photo\"; filename=\"_photo.jpg\"\r\nContent-Type: image/jpeg\r\n\r\n";
    String tail = "\r\n--DjangoBoundary--\r\n";
...
void goToDeepSleep()
{
  ...
  if (bootCount > 1)
  {
    sleepTimeMicroseconds = SLEEP_DURATION_HOURS * 3600ULL * uS_TO_S_FACTOR; // 120ULL * uS_TO_S_FACTOR; //
  }
  else
  {
